...
1. There are 8 different tilesets (4 grass and 4 rugged dirt which have their own .png file(s)).
2. There are also 8 different platforms to match above tilesets, which also have .png file(s) and the aseprite file for the animation(s).
